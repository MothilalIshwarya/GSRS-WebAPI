...
{
    public class LicenseServerGroupRepository : GSRSRepository<LicenseServerGroup>, ILicenseServerGroupRepository
    {
        #region Constructor
        public LicenseServerGroupRepository(IContext _context)
            : base(_context)
        { }
        #endregion
    }
